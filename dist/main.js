    ...
    value: function applyValidationFlagsToSteps() {
      ...
      this.props.steps.map(function (i, idx) {
        if (_this2.props.dontValidate) {
          ...
          i.validated = typeof i.component.type === 'undefined' || typeof i.component.type.prototype === 'undefined' || typeof i.component.type.prototype.isValidated === 'undefined' && !_this2.isStepAtIndexHOCValidationBased(idx) ? true : false;
        }
